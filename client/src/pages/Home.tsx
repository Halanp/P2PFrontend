  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-accent selection:text-accent-foreground flex flex-col">
      ...
      <div className="flex pt-[4.5rem] min-h-screen">
        ...
        <main className="flex-1 px-4 md:px-6 pb-12 w-full max-w-[1920px]">
          {/* Featured Hero Section (Mock) */}
          <div className="mt-6 mb-10 rounded-xl border-2 border-black dark:border-white bg-gradient-to-br from-primary to-secondary p-8 text-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] relative overflow-hidden group">
          ...
          {/* Categories Bar - Wrapped instead of horizontal scroll */}
