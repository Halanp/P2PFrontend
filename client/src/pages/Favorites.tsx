...
export default function Favorites() {
    // Using videos as favorites for demo
            ...
            <main className="flex-1 w-full max-w-[1600px] mx-auto pt-[4.5rem] px-4 md:px-8 pb-12">
                ...
                <div className="mt-6 mb-8">
                    <div className="flex items-center gap-4 mb-4">
                        <div className="p-3 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-lg border-2 border-black dark:border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
                            <Star size={32} strokeWidth={2.5} className="text-white" fill="white" />
                        </div>
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground font-mono mt-1">
                                {favoriteVideos.length} favorite videos
                            </p>
                        </div>
                    </div>
                </div>
