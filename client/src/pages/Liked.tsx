...
export default function Liked() {
    // Using videos as liked videos for demo
            ...
            <main className="flex-1 w-full max-w-[1600px] mx-auto pt-[4.5rem] px-4 md:px-8 pb-12">
                ...
                <div className="mt-6 mb-8">
                    <div className="flex items-center gap-4 mb-4">
                        <div className="p-3 bg-accent rounded-lg border-2 border-black dark:border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
                            <ThumbsUp size={32} strokeWidth={2.5} className="text-black" />
                        </div>
                        <div>
